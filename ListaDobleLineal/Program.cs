...
namespace ListaDobleLineal
{
    internal class Program
    {
        ...
        {
            ListaDobleEnlazada miLista = new ListaDobleEnlazada();
            int opcion;

            Console.WriteLine("LISTA DOBLEMENTE ENLAZADA LINEAL");
            Console.WriteLine("================================================\n");
            ...
            do
            {
                ...
                Console.WriteLine("\nRECORRIDOS:");
                Console.WriteLine("13. Recorrido adelante (frente a final)");
                Console.WriteLine("14. Recorrido atrás (final a frente)");
                ...
                switch (opcion)
                {
                    ...
                    case 13:
                        Console.WriteLine("\n--- Recorrido ADELANTE (frente a final) ---");
                        miLista.RecorridoFrenteAFinal();
                        break;

                    case 14:
                        Console.WriteLine("\n--- Recorrido ATRÁS (final a frente) ---");
                        miLista.RecorridoFinalAFrente();
                        break;
